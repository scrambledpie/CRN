...
Results = readRDS("/home/michael/CopiedResults/8002")
...
pdf("~/Dropbox/PhD/CRN/CRNKG paper/Operations-Research-Paper/April2019/pics/Code_for_plots/EC_5_DAMB_sum.pdf",
    height = 5, width = 8)
...
# FIRST PLOT PROFIT
Res_plot(R, cols = cols,  erscale = 0.5, yr=c(4.4, 4.9))
title(main = "Sum of Journey Times", font.main=1, xlab="N", ylab="")
