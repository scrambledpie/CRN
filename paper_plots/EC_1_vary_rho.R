...
pdf("~/Dropbox/PhD/CRN/CRNKG paper/Operations-Research-Paper/April2019/pics/Code_for_plots/EC_1_vary_rho.pdf",
    width = 8, height = 5)
...
Res_plot(MR_OC[SS], ran$xr, c(0.00001,30), cols=c("blue", "red", "green"), 
          log="")
...
plot_errors(MR_SF, floor(uMR/100)/10, rep(0:10, 3)/10, 15, c("blue", "red", "green"))
