...
Results = readRDS("/Users/pearce/CopiedResults/8002")

M = sapply(Results, function(r)r$method)

R = Get_multiple_OC(Results[M%in%c(2, 5, 6)], M[M%in%c(2, 5, 6)])
...
"
Experiment 8002
 - ambulance, 1800s per sim, all results, KG, PW, CRN, 400 runs each
